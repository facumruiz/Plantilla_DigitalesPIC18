...
unsigned char Botones13() {
    ...
    switch (Estado_BOT) {
        ...
        case BotonEnEspera:
            ...
            break;
        case BotonDetectado:
            if (!PORTCbits.RC7)Boton_Presionado = 4;
            else if (!PORTCbits.RC6)Boton_Presionado = 3;
            else if (!PORTCbits.RC5)Boton_Presionado = 2;
            else if (!PORTCbits.RC4)Boton_Presionado = 1;
        ...
        case BotonEsperaLiberarce:
            if (PORTCbits.RC4 && PORTCbits.RC5 && PORTCbits.RC6 && PORTCbits.RC7 && !bot_tout) Estado_BOT = BotonLibre;
            break;
        default:
            Boton_Presionado = 0;;
